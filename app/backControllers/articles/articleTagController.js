...
exports.list = function(req, res) {
    ...
    ArticleTag.find(condition).then(doc => {
        res.json({
            status: 200,
            msg: '数据获取成功',
            data: doc
...
exports.add = (req, res) => {
    ...
    ArticleTag.createAsync(req.body).then(doc => {
...
exports.getById = (req, res) => {
    let id = req.body.id;
    ArticleTag.findByIdAsync(id).then((doc) => {
        res.json({
            status: 200,
            msg: '获取数据成功',
            data: doc
...
exports.del = (req, res) => {
    ...
    ArticleTag.findByIdAndRemoveAsync(id).then(() => {
...
exports.upd = (req, res) => {
    ...
    ArticleTag.findByIdAndUpdateAsync(id, req.body, { new: true }).then(doc => {
        console.log(doc);
        if (doc) {
